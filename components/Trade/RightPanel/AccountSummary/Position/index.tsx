...
import Side from '@components/Trade/RightPanel/AccountSummary/Position/Side';
import Leverage from '@components/Trade/RightPanel/AccountSummary/Position/Leverage';
import Exposure from '@components/Trade/RightPanel/AccountSummary/Position/Exposure';
    ...
    ({ className, balances, fairPrice, maxLeverage, baseTicker, quoteTicker, filledOrders }: PTProps) => {
        ...
        return (
            <div className={className}>
                ...
                {!account ? <ConnectOverlay /> : balances.base.eq(0) ? <PositionOverlay /> : null}
            </div>
        );
    },
)`
