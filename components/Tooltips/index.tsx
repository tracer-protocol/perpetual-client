...
export const BuyingPowerTip: React.FC<TProps> = styled(({ className, base, availableMargin, maxLeverage }: TProps) => {
    return (
...
export const RealisedPnLTip: React.FC<TProps> = styled(({ className, base }: TProps) => {
    return (
        <ReactTooltipStyled id="realised-pnl" className={className} effect="solid">
            ...
            {base} position, and/or paying trading fees, funding rate payments, insurance funding rate payments and gas
            costs.
        </ReactTooltipStyled>
    );
})``;

export const UnrealisedPnLTip: React.FC<TProps> = styled(({ className, base }: TProps) => {
    return (
        <ReactTooltipStyled id="unrealised-pnl" className={className} effect="solid">
            <strong>Unrealised PnL</strong> The amount of profit or loss you would realise if you closed your {base}{' '}
...
export const PoolHoldingsTip: React.FC<TProps> = styled(({ className, base }: TProps) => {
    return (
        <ReactTooltipStyled id="pool-holdings" className={className} effect="solid">
            <strong>Pool Holdings</strong> The current holdings in the the {base} insurance pool that have been
            accumulated through a combination of deposits and insurance funding rate payments.
        </ReactTooltipStyled>
    );
})``;

export const PoolTargetTip: React.FC<TProps> = styled(({ className, base }: TProps) => {
    return (
        <ReactTooltipStyled id="pool-target" className={className} effect="solid">
            ...
            {base} market. <a>Learn more.</a>
        </ReactTooltipStyled>
    );
})``;

export const InsuranceFundingRateTip: React.FC<TProps> = styled(({ className, base }: TProps) => {
    return (
        <ReactTooltipStyled id="insurance-funding-rate" className={className} effect="solid">
            ...
            {base} market to capitalise the {base} insurance pool. The fee is applied is continuously paid and updated
