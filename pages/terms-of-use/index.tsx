        ...
        <div className={className}>
            ...
            <GeneralContainer className={`container`}>
                ...
                <BodyText>
                    ...
                    <List>
                        <ListItem>if you are entering into these Terms as an individual, then you are of legal age in the jurisdiction in which you reside and you have the legal capacity to enter into these Terms and be bound by them;</ListItem>
                        <ListItem>if you are entering into these Terms as an entity, then you must have the legal authority to accept these Terms on that entity's behalf, in which case "you" (except as used in this paragraph) will mean that entity;</ListItem>
                        <ListItem>if you are entering into these Terms to access Perpetual Swaps Contracts or will in the future access Perpetual Swaps Contracts, then you are not a US Person;</ListItem>
                        <ListItem>you do not, and will not, use VPN software or any other privacy or anonymisation tools or techniques to circumvent, or attempt to circumvent, any restrictions that apply to the Services; and</ListItem>
                        <ListItem>you are not a resident of, reside in, a citizen of, incorporated in, or have a registered office in China, the United States, Antigua and Barbuda, Algeria, Bangladesh, Bolivia, Belarus, Burundi, Myanmar (Burma), Cote D'Ivoire (Ivory Coast), Crimea and Sevastopol, Cuba, Democratic Republic of Congo, Ecuador, Iran, Iraq, Liberia, Libya, Magnitsky, Mali, Morocco, Nepal, North Korea, Somalia, Sudan, Syria, Venezuela, Yemen, Zimbabwe or any other country to which the United States, the United Kingdom or the European Union embargoes goods or imposes similar sanctions (collectively, "Restricted Territories");</ListItem> 
                        <ListItem>you are not a member of any sanctions list or equivalent maintained by the United States government, the United Kingdom government, by the European Union or the United Nations (collectively, "Sanctions Lists Persons");</ListItem>
                        <ListItem>you do not intend to transact with any Restricted Territories or Sanctions List Persons;</ListItem>
                        <ListItem>you are not a Restricted Person; and</ListItem>
                        <ListItem>your access to the Services is not (a) prohibited by and does not otherwise violate or assist you to violate any domestic or foreign law, rule, statute, regulation, by-law, order, protocol, code, decree, or another directive, requirement, or guideline, published or in force that applies to or is otherwise intended to govern or regulate any person, property, transaction, activity, event or other matter, including any rule, order, judgment, directive or other requirement or guideline issued by any domestic or foreign federal, provincial or state, municipal, local or other governmental, regulatory, judicial or administrative authority having jurisdiction over Tracer DAO, you, the Site or the Services, or as otherwise duly enacted, enforceable by law, the common law or equity (collectively, "Applicable Laws"); or (b) contribute to or facilitate any illegal activity.</ListItem>
                    </List>
                    <Text>
                        2.2 As a condition to accessing or using the Services or the Site, you acknowledge, understand, and agree to the following:
                    </Text>
                    <List>
                        <ListItem>from time to time the Site and the Services may be inaccessible or inoperable for any reason, including, without limitation: (a) equipment malfunctions; (b) periodic maintenance procedures or repairs that Tracer DAO or any of its suppliers or contractors may undertake from time to time; (c) causes beyond Tracer DAO's control or that Tracer DAO could not reasonably foresee; (d) disruptions and temporary or permanent unavailability of underlying blockchain infrastructure; or (e) unavailability of third-party service providers or external partners for any reason;</ListItem>
                        <ListItem>we reserve the right to disable or modify access to the Site and the Services at any time in the event of any breach of these Terms, including, without limitation, if we reasonably believe any of your representations and warranties may be untrue or inaccurate, and we will not be liable to you for any losses or damages you may suffer as a result of or in connection with the Site or the Services being inaccessible to you at any time or for any reason;</ListItem>
                        <ListItem>the Site and the Services may evolve, which means Tracer DAO may apply changes, replace, or discontinue (temporarily or permanently) the Services at any time in its sole discretion;</ListItem>
                        <ListItem>the pricing information provided on the Site does not represent an offer, a solicitation of an offer, or any advice regarding, or recommendation to enter into, a transaction with Tracer DAO;</ListItem>
                        <ListItem>Tracer DAO does not act as an agent for you or any other user of the Site or the Services;</ListItem>
                        <ListItem>you are solely responsible for your use of the Services, including all of your transfers of Assets;</ListItem>
                        <ListItem>to the fullest extent not prohibited by Applicable Law, we owe no fiduciary duties or liabilities to you or any other party, and that to the extent any such duties or liabilities may exist at law or in equity, you hereby irrevocably disclaim, waive, and eliminate those duties and liabilities;</ListItem>
                        <ListItem>your use of the Services is at your own risk and you agree that Tracer DAO is not liable for any damage or harm arising out of your use of the Services;</ListItem>
                        <ListItem>you are solely responsible for reporting and paying any taxes applicable to your use of the Services; and</ListItem>
                        <ListItem>we have no control over, or liability for, the delivery, quality, safety, legality, or any other aspect of any Assets that you may transfer to or from a third party, and we are not responsible for ensuring that an entity with whom you transact completes the transaction or is authorised to do so, and if you experience a problem with any transactions in Assets using the Services, then you bear the entire risk.</ListItem>
                    </List>
                    <Text>
                        2.3 As a condition to accessing or using the Services or the Site, you covenant to Tracer DAO the following:
                    </Text>
                    <List>
                        <ListItem>in connection with using the Services, you only will transfer legally-obtained Assets that belong to you;</ListItem>
                        <ListItem>you will obey all Applicable Laws in connection with using the Services, and you will not use the Site or the Services if the laws of your country, or any other Applicable Law, prohibit you from doing so;</ListItem>
                        <ListItem>any Assets you use in connection with the Services are either owned by you or you are validly authorised to carry out actions using such Assets;</ListItem>
                        <ListItem>in addition to complying with all restrictions, prohibitions, and other provisions of these Terms, you will (a) ensure that, at all times, all information that you provide on the Site and during your use of the Services is current, complete, and accurate; (b) maintain the security and confidentiality of your private keys associated with your public Ethereum address, passwords, API keys and other related credentials.</ListItem>
                    </List>
                    <Title>
                    ...
                    <List>
                        <ListItem>violate any Applicable Laws including, without limitation, any relevant and applicable anti-money laundering and anti-terrorist financing laws and sanctions programs and legislation;</ListItem>
                        <ListItem>use the Services in any manner that could interfere with, disrupt, negatively affect, or inhibit other users from fully enjoying the Services, or that could damage, disable, overburden, or impair the functioning of the Site or the Services in any manner;</ListItem>
                        <ListItem>circumvent any content-filtering techniques, security measures or access controls that Tracer DAO employs on the Site, including, without limitation, through the use of a VPN;</ListItem>
                        <ListItem>use any robot, spider, crawler, scraper, or other automated means or interface not provided by us, to access the Services or to extract data, or introduce any malware, virus, Trojan horse, worm, logic bomb, drop-dead device, backdoor, shutdown mechanism or other harmful material into the Site or the Services;</ListItem>
                        <ListItem>provide false, inaccurate, or misleading information while using the Site or the Services or engage in activity that operates to defraud Tracer DAO, other users of the Services, or any other person;</ListItem>
                        <ListItem>use or access the Site or Services to transmit or exchange Assets that are the direct or indirect proceeds of any criminal or fraudulent activity, including, without limitation, terrorism or tax evasion;</ListItem>
                        <ListItem>use the Site in any way that is, in our sole discretion, libelous, defamatory, profane, obscene, pornographic, sexually explicit, indecent, lewd, vulgar, suggestive, harassing, stalking, hateful, threatening, offensive, discriminatory, bigoted, abusive, inflammatory, fraudulent, deceptive, or otherwise objectionable or likely or intended to incite, threaten, facilitate, promote, or encourage hate, racial intolerance, or violent acts against others;</ListItem>
                        <ListItem>use the Site or the Services from a jurisdiction where the use of the Site or the Services is prohibited;</ListItem>
                        <ListItem>harass, abuse, or harm of another person or entity, including Tracer DAO members, Service Providers and users;</ListItem>
                        <ListItem>impersonate another user of the Services or otherwise misrepresent yourself; or</ListItem>
                        <ListItem>encourage, induce or assist any third party, or yourself attempt, to engage in any of the activities prohibited under this Section 5 or any other provision of these Terms.</ListItem>
                    </List>
                    <Title>
                        6. CONTENT
                    </Title>
                    ...
                    <Text>
                        10.1 By utilising the Services or interacting with the Site in any way, you represent and warrant that you understand the inherent risks associated with cryptographic systems and blockchain-based networks; cryptocurrencies, cryptographic tokens and other blockchain based-assets, including the usage and intricacies of native cryptographic tokens, like ether (ETH); smart contract-based tokens, such as those that follow the Ethereum Token Standard; and systems that interact with blockchain-based networks. Tracer DAO does not own or control any of the underlying software through which blockchain networks are formed. In general, the software underlying blockchain networks, including the Ethereum blockchain, is open source, such that anyone can use, copy, modify, and distribute it. By using the Services, you acknowledge and agree (a) that Tracer DAO is not responsible for the operation of the software and networks underlying the Services, (b) that there exists no guarantee of the functionality, security, or availability of that software and networks, and (c) that the underlying networks are subject to sudden changes in operating rules, such as those commonly referred to as "forks," which may materially affect the Services. Blockchain networks use public/private key cryptography. You alone are responsible for securing your private key(s). We do not have access to your private key(s). Losing control of your private key(s) will permanently and irreversibly deny you access to Assets on the Ethereum blockchain or other blockchain-based network. Neither Tracer DAO nor any other person or entity will be able to retrieve or protect your Assets. If your private key(s) are lost, then you will not be able to transfer your Assets to any other blockchain address or wallet. If this occurs, then you will not be able to realise any value or utility from the Assets that you may hold.
                    </Text>
                    <Text>
                        10.2 The Services and your Assets could be impacted by one or more regulatory inquiries or regulatory actions, which could impede or limit the ability of Tracer DAO to continue to make available its proprietary software and, thus, could impede or limit your ability to access or use the Services.
                    </Text>
                    <Text>
                    ...
                    <Text>
                        10.5 You acknowledge that the Services are subject to flaws and that you are solely responsible for evaluating any code provided by the Services or Site. This warning and others Tracer DAO provides in these Terms in no way evidence or represent an on-going duty to alert you to all of the potential risks of utilising the Services or accessing the Site.
                    </Text>
                    <Text>
                    ...
                    <Text>
                        10.8 Use of the Services, in particular entering into Perpetual Swap Contracts, may carry financial risk. The Services are, by their nature, highly experimental, risky, and volatile. Transactions entered into in connection with the Services are irreversible, final and there are no refunds. You acknowledge and agree that you will access and use the Site and the Services at your own risk. The risk of loss of Assets in connection with the Services, especially using Perpetual Swap Contracts, can be substantial. You should, therefore, carefully consider whether such transactions are suitable for you in light of your circumstances and financial resources. By using the Services, you represent and warrant that you have been, are, and will be solely responsible for making your independent appraisal and investigations into the risks of a given transaction and the underlying Assets. You represent that you have sufficient knowledge, market sophistication, professional advice, and experience to make your evaluation of the merits and risks of any transaction conducted in connection with the Services or any Asset. You accept all consequences of using the Services, including the risk that you may lose access to your Assets indefinitely. All transaction decisions are made solely by you. Notwithstanding anything in these Terms, we accept no responsibility whatsoever for, and will in no circumstances be liable to you in connection with, your use of the Services for performing Asset transactions, including entering into Perpetual Swap Contracts.
                    </Text>
                    <Text>
                    ...
                    <Text>
                        12.3 Tracer DAO does not own or control the underlying software protocols that are used in connection with Perpetual Swaps Contracts. In general, the underlying protocols are open source and anyone can use, copy, modify, and distribute them. Tracer DAO is not responsible for the operation of the underlying protocols, and Tracer DAO makes no guarantee of their functionality, security, or availability.
                    </Text>
                    <Text>
                    ...
                    <Text>
                        15.5 You and Tracer DAO agree that for any arbitration you initiate, you will pay the filing fee and all other costs. For any arbitration initiated by Tracer DAO, Tracer DAO will pay all fees and costs.
                    </Text>
                    <Text>
