            ...
            <GeneralContainer className={`container`}>
                ...
                <BodyText>
                    ...
                    <List>
                        ...
                        <ListItem>transactional information, such as information about the transactions you make on our services, such as the type, time or amount of a transaction;</ListItem>
                        <ListItem>correspondence, such as your feedback or questionnaire and other survey responses; </ListItem>
                        <ListItem>online identifiers, such as your blockchain address, device ID, device type, geo-location information, computer and connection information, statistics on page views, traffic to and from the sites, ad data, IP address and standard web log information;</ListItem>
                        <ListItem>usage data, such as user preferences and other data collected;</ListItem>
                        <ListItem>details of the products and services we have provided to you or that you have enquired about, including any additional information necessary to deliver those products and services and respond to your enquiries;</ListItem>
                        <ListItem>any additional information relating to you that you provide to us directly through our website or app or indirectly through your use of our website or app or online presence or through other websites or accounts from which you permit us to collect information; or</ListItem>
                        <ListItem>any other personal information that may be required in order to facilitate your dealings with us.</ListItem>
                    </List>
                    <Title>
                    ...
                    <List>
                        ...
                        <ListItem>communicate with us through correspondence, chats, email, or when you share information with us from other social applications, services or websites; or</ListItem>
                        ...
                        <ListItem>We may collect, hold, use and disclose your personal information for the following purposes:</ListItem>
                        <ListItem>to enable you to access and use our website, services and app;</ListItem>
                        <ListItem>to operate, protect, improve and optimise our website, services and app, business and our users' experience, such as to perform analytics, conduct research and for advertising and marketing; </ListItem>
                        <ListItem>to send you service, support and administrative messages, reminders, technical notices, updates, security alerts, and information requested by you;</ListItem>
                        <ListItem>to send you marketing and promotional messages and other information that may be of interest to you, including information sent by, or on behalf of, our business partners that we think you may find interesting;</ListItem>
                        <ListItem>to administer rewards, surveys, contests, or other promotional activities or events sponsored or managed by us or our business partners;</ListItem>
                        <ListItem>to comply with our legal obligations, resolve any disputes that we may have with any of our users, and enforce our agreements with third parties; and</ListItem>
                    ...
                    <List>
                        <ListItem>third party suppliers and service providers (including providers for the operation of our websites and/or our business or in connection with providing our products and services to you);</ListItem>
                        ...
                        <ListItem>other persons, including government agencies, regulatory bodies and law enforcement agencies, or as required, authorised or permitted by law.</ListItem>
                    </List>
                    <Title>
